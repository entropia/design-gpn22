...
from ../../generator/gpn22_design_generator import design
...
# or
#
# ffmpeg -r 30 -f image2 -s 1920x1080  -i congress_info%d.png -c:v:0 libx264 -pix_fmt yuv420p -crf:0 20 -profile:0 high -level:0 4.1 gpn22_congress_infobeamer_1080p_final.mp4
#
